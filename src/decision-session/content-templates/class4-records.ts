...
export const ABSENCE_DEPENDENCY_AUDIT_GAP_RECORD: ContentTemplateRecord = {
  ...
  levelForms: {
    ...
    2: form("Evaluate the new dependency before committing to it: maintenance status, licence compatibility, and whether a lighter alternative exists.", "Weigh this new dependency before committing — maintenance status, licence compatibility, and whether a lighter alternative fits."),
