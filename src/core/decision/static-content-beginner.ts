// Relocated verbatim from src/decision-session/options-beginner.ts — see static-content.ts's
// header comment for why this lives here instead of the (now-deleted) original CLI location.
