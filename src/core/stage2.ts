...
import type { SessionState, Stage, AbsenceFlag } from './classifier/types.js';
 ...
 * @param stage2Config  Optional overrides for confidence threshold and context window
