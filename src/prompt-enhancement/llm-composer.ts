...
const SYSTEM_PROMPT = [
  ...
  '- Write: "I have not asked for tests recently — you should add tests for this change."',
  ...
  '  ✅ Correct: "I have not set up test creation for this yet, so you should add tests for this',
  '     change." The reader learns WHICH signal; that is the entire reason the name is given to you.',
