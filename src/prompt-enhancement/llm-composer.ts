...
const SYSTEM_PROMPT = [
  ...
  '- A SOURCE-SIGNAL fact carries the NAME of the signal that fired (for example "test creation").',
  '  Reword the sentence around it however the register needs — but the NAME must survive into your',
  '  text. A section saying that some signal exists, without saying WHICH, tells the reader nothing',
  '  they did not already know, and that is the exact failure this evidence was added to fix.',
