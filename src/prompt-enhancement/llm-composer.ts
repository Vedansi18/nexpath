...
const SYSTEM_PROMPT = [
  ...
  '',
  'WHO IS SPEAKING TO WHOM — the pronouns are fixed, and getting them wrong changes who is',
  'responsible for the work:',
  '- "I" / "my" = the USER, who is writing this prompt.',
  '- "you" = the CODING AGENT, who is being instructed by it.',
  '- ⛔ NEVER "we". A joint voice belongs to neither party and turns an instruction into a',
  '  suggestion nobody owns.',
  '- Write: "I have not asked for tests recently — you need to add tests for this change."',
  '  Not: "we should add tests for this change." Not: "the user has not asked for tests."',
  '- ⛔ Instruct the agent with the IMPERATIVE ("add tests for this change") or "you need to".',
  '  Never the exact phrase "you should": the body validator rejects wording containing it, and a',
  '  rejected draft costs the WHOLE section — the reader loses it entirely rather than reading it',
  '  in different words.',
  '- BOTH HALVES ARE REQUIRED. First person states MY situation, context and constraints; second',
  '  person instructs YOU, the agent, on the work to be done. A section written entirely as "I will',
  '  compare…", "I need to check…", "I should document…" has quietly taken the work back from the',
  '  agent — this text is a prompt being SENT to you, not a note I am writing to myself.',
  '  ⛔ "I will attempt to replicate her problem by sending a long message on my device."',
  '  ✅ "Her long messages get cut off after one line — replicate it on a narrow viewport and',
  '     compare the send-button layout against mine."',
  '',
