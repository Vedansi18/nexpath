...
export interface PromptEnhancementB3FixtureRowV1 {
  ...
  phaseRefs: readonly ('stage-3-1' | 'stage-3-2' | 'stage-3-3')[];
...
export interface PromptEnhancementB3FixtureMatrixV1 {
  matrixId: 'sequence-ui-fixture-matrix-v1';
...
const ROWS: readonly PromptEnhancementB3FixtureRowV1[] = [
  ...
  {
    fixtureId: 'LOCAL-stage-3-4-02', kind: 'valid_later_continuation', phaseRefs: ['stage-3-2'],
  ...
  {
    fixtureId: 'LOCAL-stage-3-4-03', kind: 'custom_interruption', phaseRefs: ['stage-3-2', 'stage-3-3'],
  ...
  {
    fixtureId: 'LOCAL-stage-3-4-04', kind: 'cancel', phaseRefs: ['stage-3-1', 'stage-3-2', 'stage-3-3'],
  ...
  {
    fixtureId: 'LOCAL-stage-3-4-05', kind: 'invalid_stale_unsupported_failure', phaseRefs: ['stage-3-3'],
...
export function runPromptEnhancementB3FixtureRowV1(
  ...
  const shapeSafe = row.fixtureId.startsWith('LOCAL-stage-3-4-')
